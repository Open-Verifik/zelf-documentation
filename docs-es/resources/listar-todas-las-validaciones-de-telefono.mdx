---
id: listar-todas-las-validaciones-de-telefono
title: Listar Todas las Validaciones de Teléfono
description: Recuperar una lista de todas las validaciones de teléfono con filtrado opcional y paginación
slug: /recursos/listar-todas-las-validaciones-de-telefono
---
...
Este servicio recupera una lista de todas las validaciones de teléfono con filtrado opcional y paginación. Puedes filtrar por proyecto, estado, tipo y otros parámetros para encontrar validaciones de teléfono específicas.
...
| `status`      | string  | Filtrar por estado: `new`, `sent`, `validated`, `failed`                                     |
| `type`        | string  | Filtrar por tipo: `validation`, `login`, `onboarding`                                         |
| `countryCode` | string  | Filtrar por código de país                                                                     |
| `phone`       | string  | Filtrar por número de teléfono                                                                 |
...
- **Múltiples Estados**: Filtra por estado (nuevo, enviado, validado, fallido)
