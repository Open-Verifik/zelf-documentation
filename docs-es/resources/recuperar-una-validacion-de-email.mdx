---
id: recuperar-una-validacion-de-email
title: Recuperar una Validación de Email
description: Recuperar un registro de validación de email específico usando su identificador único
slug: /recursos/recuperar-una-validacion-de-email
---
...
Este servicio recupera un registro de validación de email específico usando su identificador único. La respuesta incluye todos los detalles sobre el proceso de validación de email, incluyendo estado, información OTP y datos del proyecto asociado.
...
| ---- | ------ | ---------------------------------------------------------------- |
| `id` | string | El identificador único del registro de validación de email que quieres recuperar. |
...
{
  "success": false,
  "error": "Validación de email no encontrada",
