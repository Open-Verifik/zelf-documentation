---
title: Bolivia
description: Servicio de validación empresarial en Bolivia
slug: /validacion-empresarial/bolivia
---
...
Obtén datos de empresas bolivianas por identificador tributario.
...
| --- | --- | --- | --- |
| `documentNumber` | string | Sí | Identificador de la empresa. |
...
```json
{
  "data": {
    "documentNumber": "1234567",
    "companyName": "Empresa Bolivia S.R.L.",
    "status": "active"
  },
...
- Contacta a soporte para el conjunto completo de campos.
