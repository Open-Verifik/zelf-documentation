...
[1.-retrieve-public-key](https://docs.zelf.world/zelf-name-service/online-version/1.-retrieve-public-key "mention")

### Request

* **Endpoint**: `/api/zelf-name-service/v2/lease`
* **Method**: POST
...
```json
{
  "type": "create"/"import", // it can be either 'create' or 'import' 
  "wordsCount": "12"/"24",
  "faceBase64": "<PGP_encrypted_message>",
  "password": "(optional)<PGP_encrypted_message>",
  "mnemonic": "[IMPORT ONLY] a valid seed phrase goes here (12/24 words)",
  "os": "DESKTOP",
  "addServerPassword": true/false,
  "removePGP": true, // only if you are not using the PGP encryption via API,
  "previewZelfProof": true/false
}
```
...
payload = json.dumps({
  ...
  "wordsCount": 12,
  "removePGP": True,
  "faceBase64": "/9j/4AAQSkZJRgABAQ...kwp/9k="
})
headers = {
  'Content-Type': 'application/json',
  'Authorization': 'Bearer eyJhbGci6IkpXVCJ9.eyJjbGll...lFSNM'
}
conn.request("POST", "/api/zelf-name-service/lease", payload, headers)
...
<TabItem value="Kotriln" label="Kotriln">
...
```json
{
    "data": {
        ...
        "publicData": {
            ...
            "zelfName": "yourzelfname.zelf.hold",
            "origin": "online",
            "name": "yourzelfname.zelf.hold",
            "type": "hold",
            "hasPassword": "true",
        ...
        "hasPassword": true,
        "metadata": {
            "mnemonic": "tiger wood talent truck noodle slow door frog gun infant release submit",
            "solanaSecretKey": "1UABg84Gei8bDkLJnMdw4EUw6wFS9HfWztCTae4v7zcv7yFkwPfTM1dNtvS6n4uJoaAq8pJnxNpgo8Zi4VY9DYQ"
        },
        ...
        "ipfs": {
            ...
            "IpfsHash": "bafkreia2c5fmaevhkov264tngrradq4jv3rf2cox54zcy2jfcpy6snwvma",
            "PinSize": 18104,
            "Timestamp": "2025-06-12T19:15:50.312Z",
            "ID": "dbfb9fc3-63f7-4962-99b7-5abc63c0c695",
        ...
        "pgp": {
            "encryptedMessage": "-----BEGIN PGP MESSAGE-----\n\\n=RjrI\n-----END PGP MESSAGE-----\n",
