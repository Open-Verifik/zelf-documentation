...
id: costa-rica
title: Costa Rica
description: Verify Costa Rican citizen identities using CCCR (Cédula)
---
...
Verify Costa Rican Cédula and return identity details.
...
| `documentNumber` | string | Yes | Cédula number without spaces. |
...
- Provide the number without spaces or dots.
