...
id: uruguay
title: Uruguay
description: Verify Uruguayan IDs using CCUY (requires date of birth)
---
...
Verify Uruguayan ID by `documentType=CCUY`, `documentNumber`, and `dateOfBirth`.
...
- Date of birth required and must match.
